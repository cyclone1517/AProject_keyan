		...
		<div id="cyl_basicInfo">
			...
			<table>
				<tr>
					...
					<td><input type="text" name="emain" id="cyl_emain" value="5678XXXX" style="width:280px" disabled></td>
				</tr>
				<tr>
					<td>姓&ensp;&ensp;名</td>
					<td><input type="text" name="emain" id="cyl_emain" value="张三" style="width:280px" disabled></td>
				</tr>
				<tr>
					<td>学&ensp;&ensp;院</td>
					<td><input type="text" name="emain" id="cyl_emain" value="信息院" style="width:280px" disabled></td>
				</tr>
				<tr>
					<td>职&ensp;&ensp;称</td>
					<td><select>
